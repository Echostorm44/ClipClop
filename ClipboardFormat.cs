...
public enum ClipboardFormat : byte
{
    ...
    EnhancedMetafile,
    /// <summary>
    /// Specifies the Windows metafile format, which Windows Forms does not directly use. This static field is read-
    /// only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    MetafilePict,
    /// <summary>
    /// Specifies the Windows symbolic link format, which Windows Forms does not directly use. This static field is
    /// read-only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    SymbolicLink,
    ...
    Dif,
    /// <summary>
    /// Specifies the Tagged Image File Format (TIFF), which Windows Forms does not directly use. This static field is
    /// read-only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    Tiff,
    /// <summary>
    /// Specifies the standard Windows original equipment manufacturer (OEM) text format. This static field is read-
    /// only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    OemText,
    ...
    Palette,
    /// <summary>
    /// Specifies the Windows pen data format, which consists of pen strokes for handwriting software, Windows Forms
    /// does not use this format. This static field is read-only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    PenData,
    /// <summary>
    ...
    WaveAudio,
    /// <summary>
    /// Specifies the Windows file drop format, which Windows Forms does not directly use. This static field is read-
    /// only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    FileDrop,
    ...
    Rtf,
    /// <summary>
    /// Specifies a comma-separated value (CSV) format, which is a common interchange format used by spreadsheets. This
    /// format is not used directly by Windows Forms. This static field is read-only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    CommaSeparatedValue,
    /// <summary>
    /// Specifies the Windows Forms string class format, which Windows Forms uses to store string objects. This static
    /// field is read-only.
    /// </summary>
    /// <filterpriority>1</filterpriority>
    StringFormat,
